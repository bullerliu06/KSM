...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate, UnreadCountProvider {
	...
	nonisolated let log = OSLog(subsystem: Bundle.main.bundleIdentifier!, category: "Application")
...
private extension AppDelegate {
	...
	private func initializeHomeScreenQuickActions() {
		...
		let unreadItem = UIApplicationShortcutItem(type: "com.sotech.Collector.FirstUnread", localizedTitle: unreadTitle, localizedSubtitle: nil, icon: unreadIcon, userInfo: nil)
		
		let searchTitle = NSLocalizedString("Search", comment: "Search")
		let searchIcon = UIApplicationShortcutIcon(systemImageName: "magnifyingglass")
		let searchItem = UIApplicationShortcutItem(type: "com.sotech.Collector.ShowSearch", localizedTitle: searchTitle, localizedSubtitle: nil, icon: searchIcon, userInfo: nil)

		let addTitle = NSLocalizedString("Add Feed", comment: "Add Feed")
		let addIcon = UIApplicationShortcutIcon(systemImageName: "plus")
		let addItem = UIApplicationShortcutItem(type: "com.sotech.Collector.ShowAdd", localizedTitle: addTitle, localizedSubtitle: nil, icon: addIcon, userInfo: nil)
...
private extension AppDelegate {
	...
	func registerBackgroundTasks() {
		...
		BGTaskScheduler.shared.register(forTaskWithIdentifier: "com.sotech.Collector.FeedRefresh", using: nil) { (task) in
	...
	func scheduleBackgroundFeedRefresh() {
		let request = BGAppRefreshTaskRequest(identifier: "com.sotech.Collector.FeedRefresh")
