...
//  Collector
//
//  Created by Solid Omit on 4/24/19.
...
final class SettingsViewController: UITableViewController {
	...
	@IBOutlet weak var openLinksInCollector: UISwitch!
	...
	override func viewWillAppear(_ animated: Bool) {
		...
		openLinksInCollector.isOn = !AppDefaults.shared.useSystemBrowser
	...
	override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
		...
		case 2:
			...
			if AccountManager.shared.activeAccounts.isEmpty || AccountManager.shared.anyAccountHasCollectorNewsSubscription() {
...
private extension SettingsViewController {
	...
	func addFeed() {
		...
		addViewController.initialFeed = AccountManager.collectorNewsURL
		addViewController.initialFeedName = NSLocalizedString("Collector News", comment: "Collector News")
