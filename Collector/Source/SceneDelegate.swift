...
//  Collector
//
//  Created by Solid Omit on 6/28/19.
...
final class SceneDelegate: UIResponder, UIWindowSceneDelegate {
	...
	func scene(_ scene: UIScene, openURLContexts urlContexts: Set<UIOpenURLContext>) {
		...
		DispatchQueue.main.async {
			...
			// Handle theme URLs: collector://theme/add?url={url}
...
private extension SceneDelegate {
	...
	func handleShortcutItem(_ shortcutItem: UIApplicationShortcutItem) {
		...
		case "com.sotech.Collector.FirstUnread":
			coordinator.selectFirstUnreadInAllUnread()
		case "com.sotech.Collector.ShowSearch":
			coordinator.showSearch()
		case "com.sotech.Collector.ShowAdd":
