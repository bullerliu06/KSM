...
class AccountInspectorViewController: UITableViewController {
	...
	@IBAction func deleteAccount(_ sender: Any) {
		...
		let message: String = {
			switch account.accountType {
			case .feedly:
				return NSLocalizedString("Are you sure you want to remove this account? Collector will no longer be able to access articles and feeds unless the account is added again.", comment: "Log Out and Remove Account")
			default:
