...
//  Account
//
//  Created by Solid Omit on 9/10/19.
...
public enum FeedlyAccountDelegateError: LocalizedError, Sendable {
	...
	public var recoverySuggestion: String? {
		...
		case .unexpectedResourceID:
			let template = NSLocalizedString("Please contact Collector support.", comment: "Feedly – Recovery suggestion for not being able to encode a resource id to send to Feedly..")
