...
//  Collector
//
//  Created by Solid Omit on 7/18/15.
...
@MainActor public final class AccountManager: UnreadCountProvider {
    ...
    //TODO...
    public static let collectorNewsURL = "https://"
    private static let jsonCollectorNewsURL = "https://"
	...
	public init() {
		...
		let localAccountFolder = AppConfig.ensureSubfolder(named: "localstore", folderURL: self.accountsFolderURL).path
	...
	public func deleteAccount(_ account: Account) {
		...
		do {
			...
			assertionFailure("Could not create folder for localstore account.")
			abort()
		}
	...
	public func anyAccountHasCollectorNewsSubscription() -> Bool {
		return anyAccountHasFeedWithURL(Self.collectorNewsURL) || anyAccountHasFeedWithURL(Self.jsonCollectorNewsURL)
	}
