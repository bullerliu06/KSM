...
//  Collector
//
//  Created by Solid Omit on 9/26/15.
...
struct ArticleTheme: Equatable, Sendable {
	...
	init() {
		self.path = nil;
		self.info = ArticleThemePlist(name: "Article Theme", themeIdentifier: "com.sotech.collector.theme.article", creatorHomePage: "https://", creatorName: "Sotech Company", version: 1)
