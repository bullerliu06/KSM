-- This script grabs the current article in Collector and copies relevant information about it 
...
-- first, get some relevant info out for Collector
tell application "Collector"
...
set messageSubject to "From Collector to you: " & articleTitle
set myIntro to "Here's something" & getAuthorStub(authorNames) & "that I was reading on Collector: "
