...
@property (nonatomic, strong) IconTitleView *maleIcon;
@property (nonatomic, strong) IconTitleView *femaleIcon;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        _maleIcon = [[IconTitleView alloc] initWithFrame:CGRectMake(ScreenWidth - 10 - 160, 0, 80, 40) title:@" Male" color:rgba(170, 208, 255, 1) font:14 icon:@"gender_unselected"];
        ...
        _femaleIcon = [[IconTitleView alloc] initWithFrame:CGRectMake(ScreenWidth - 10 - 80, 0, 80, 40) title:@" Female" color:rgba(170, 208, 255, 1) font:14 icon:@"gender_unselected"];
...
- (void)loadData:(NSDictionary *)dic {
    ...
    _selectValue = [self.saveDic[code] stringValue];
    [self refreshUI];
}
...
- (void)maleClick:(UIButton *)sender {
    _selectValue = @"1";
    _saveDic[_dic[p_code]] = _selectValue;
    [self refreshUI];
}
