...
@property (nonatomic, strong) CustomAlert *stayAlert;
@end
...
- (void)showAlert:(NSString *)title icon:(NSString *)icon {
    ...
    UIButton *cancelBtn = [HView normalBtn:CGRectMake(14, descLabel.bottom + 6, alertView.w - 28, 42) title:@"Cancel" font:18];
    [cancelBtn addTarget:self action:@selector(cancelAction) forControlEvents:UIControlEventTouchUpInside];
    [alertView addSubview:cancelBtn];
    
    UIButton *confirmBtnItem = [HView normalBtn:CGRectMake(14, cancelBtn.bottom, alertView.w - 28, 42) title:@"Confirm" font:18];
    ...
    _stayAlert = [[CustomAlert alloc] initWithCustomView:alertView];
    [_stayAlert show];
}
