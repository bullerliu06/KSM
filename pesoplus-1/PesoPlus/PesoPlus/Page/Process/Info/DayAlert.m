...
- (void)loadUI {
    ...
    NSInteger minValue = [self timeWithString:@"01-01-1960" formatter:@"dd-MM-yyyy"];
    NSInteger maxValue = [self timeWithString:@"31-12-2040" formatter:@"dd-MM-yyyy"];
    ...
    NSInteger times = [self timeWithString:_dateStr formatter:@"dd-MM-yyyy"];
    _dateStr = [self stringWithTime:times formatter:@"dd-MM-yyyy"];
    ...
    UIButton *confirmItem = [HView normalBtn:CGRectMake(20, _datePicker.bottom + 15, alertWidth - 40, 48) title:@"Confirm" font:18];
