...
- (void)setType:(HaoBtnType)type {
    if (type == HaoBtnType1) {
        ...
        [self setImageEdgeInsets:UIEdgeInsetsMake(0, self.frame.size.width - self.titleLabel.bounds.size.width - self.imageView.bounds.size.width - 8, 0, 0)];
    }
    _type = type;
}
